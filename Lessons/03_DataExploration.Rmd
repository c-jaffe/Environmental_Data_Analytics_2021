...
# .. backs up to folder one level back.
...
str(USGS.flow.data) # displays structure of object
dim(USGS.flow.data) # dimensions
length(USGS.flow.data) # columns

head(USGS.flow.data)
head(USGS.flow.data, 10)
tail(USGS.flow.data, 5)
USGS.flow.data[30000:30005, c(3, 8, 14)] # rows 30000-30005. columns 3 8 and 14
