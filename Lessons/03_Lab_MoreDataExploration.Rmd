...
```{r}
# Vectors ----
vector1 <- c(1,2,5.3,6,-2,4) # numeric vector, all must be same type.
vector1
...
highF <- c(53, 55, 54, 49, 53, 56, 53, 42, 37, 42)
lowF <- c(25, 41, 28,30,20,33,21,18,26,20)
...
highC <- to_celcius(highF)

lowC <- to_celcius(lowF)
...
tempDf <- data.frame(highF, lowF, highC, lowC) #create dataframe

colnames(tempDf) <- c("High_F", "Low_F", "High_C", "Low_C")
