...
# set wd for knit PDF to class folder
...
commonSites <- intersect(O3_2018_processed$Site.Name,
                         PM25_2019_processed$Site.Name)
print(commonSites)
# Some entries have a blank site name, item #13 in list is blank.
# remove blank site name (item #13 in list):
commonSites <- commonSites[-13]
